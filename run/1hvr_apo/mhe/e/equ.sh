...
do
    ...
    then
		...
		mdin=${i/*/"$i"equ.in}		
    	mdout=${i/*/"$i"equ.out}
	    prmtop=${i/*/1hvr_apo.prmtop}
	    inpcrd=${i/*/h1hvr_apo.rst7}
	    restrt=${i/*/"$i"e1hvr_apo.rst7}
    	refc=${i/*/h1hvr_apo.rst7}
	    mdcrd=${i/*/"$i"e1hvr_apo.nc}
    ...
    then
        ...
        mdout=${i/*/"$i"equ.out}
        prmtop=${i/*/1hvr_apo.prmtop}
        inpcrd=${i/*/"$k"e1hvr_apo.rst7}
        restrt=${i/*/"$i"e1hvr_apo.rst7}
        refc=${i/*/"$k"e1hvr_apo.rst7}
        mdcrd=${i/*/"$i"e1hvr_apo.nc}
